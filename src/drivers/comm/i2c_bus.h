...
#if ESP_IDF_VERSION <= ESP_IDF_VERSION_VAL(4, 4, 0) && !defined(ARDUINO_ESP32_RELEASE_2_0_1) && !defined(ARDUINO_ESP32_RELEASE_2_0_2)
  #define I2C_BUS_OLDVERSION
#endif
