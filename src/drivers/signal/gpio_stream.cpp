...
void GPIOStream::floatToFraction(double value, int maxDen, int * num, int * den)
{
...
void GPIOStream::APLLCalcParams(double freq, APLLParams * params, uint8_t * a, uint8_t * b, double * out_freq, double * error)
{
