...
void i8259::write(int addr, uint8_t value)
{
  switch (addr) {
...
// ret: 0..7
// 256 = no bit set
int i8259::getHighestPriorityBitNum(uint8_t value)
{
  if (value) {
    for (int i = 0; i < 8; ++i)
      if ((value >> i) & 1)
...
void i8259::setPendingInterrupt()
{
...
bool i8259::signalInterrupt(int intnum)
{
...
void i8259::ackPendingInterrupt()
{
