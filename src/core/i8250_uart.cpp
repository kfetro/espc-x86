...
void i8250::setSerialPort(SerialPort * value)
{
  m_serialPort = value;
...
void i8250::rxCallback(void * args, uint8_t value, bool fromISR)
{
  auto obj = (i8250 *) args;
...
bool i8250::rxReadyCallback(void * args, bool fromISR)
{
  return true;
}

uint8_t i8250::read(int reg)
{
  uint8_t ret = 0;
...
void i8250::write(int reg, uint8_t value)
{
  switch(reg & 7) {
