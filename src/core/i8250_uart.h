...
// Intel 8250 Universal Asynchronous Receiver/Transmitter (UART) with FIFOs

class i8250 {

public:

  typedef bool (*InterruptCallback)(i8250 *source, void *context);
  
   i8250(int freq = PC8250_DEFAULT_FREQ_HZ);
  ~i8250();
